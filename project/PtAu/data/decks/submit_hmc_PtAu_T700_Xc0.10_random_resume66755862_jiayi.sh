#!/bin/bash
# Resume Pt(Au) HMC point T=700 K, X_c=0.10 from the newest restart produced
# by job 66755862 in /cluster/scratch/jiayfu/prototype_PtAu_100A.

#SBATCH --job-name=hmc_PtAu_T700_Xc0.10_resume
...
SWAPS_PER_CALL=100
RESTART_PS=5
OLD_STUB=hmc_PtAu_T700_Xc0.10_random
OUTSTUB=hmc_PtAu_T700_Xc0.10_random_resume66755862
FD_PRED=0.1605
...
echo "Variant       : Pt(Au) HMC resume from job 66755862"
echo "T             : $T K"
echo "X_c           : $XC"
