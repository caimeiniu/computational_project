#!/bin/bash
# HMC point at T=500 K, X_c=5e-4 (well below FD knee, expect X_GB^FD ≈ 0.105).
# Companion to dry-run (5e-3) and high-X_c (5e-2) — three points span the knee.

#SBATCH --job-name=hmc_AlMg_T500_Xc5e-4
...
T=500.0
XC=0.0005          # 5e-4, well below FD knee at 500 K (FD predicts X_GB ≈ 0.105)
EQUIL_PS=10
PROD_PS=50
...
echo "T         : $T K"
echo "X_c       : $XC  (FD prediction X_GB^FD ≈ 0.105)"
