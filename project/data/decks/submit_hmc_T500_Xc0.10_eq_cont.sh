#!/bin/bash
# Equilibration sweep job (2026-05-05): T=500 K, X_c=0.10 continuation.
# Continues from data/snapshots/hmc_T500_Xc0.10_preseg_final.lmp
# (X_GB at end of prior 300 ps PROD = 0.3749, gap = +0.023 vs canon-FD
# 0.3519 — preseg UB still above FD, need to descend ~0.025).

#SBATCH --job-name=hmc_AlMg_T500_Xc0.10_eq_cont
...
SNAPSHOT=$REPO/data/snapshots/hmc_T500_Xc0.10_preseg_final.lmp
...
SWAPS_PER_CALL=100
RESTART_PS=5
OUTSTUB="hmc_T${T%.*}_Xc0.10_eq_cont"
FD_PRED=0.3519
...
echo "Initial Mg     : prior _final.lmp (X_GB(prior end)=0.3749)"
