#!/bin/bash
# 16-rank variant of submit_hmc_T500_Xc0.06_preseg.sh (CHANGELOG 2026-05-01
# evening): original 32-rank job 65224958 cancelled after >30 h pending
...
# can run concurrently; expected wallclock ~17 h (≈1.7x of 10h20m at
# 32 ranks); 20 h budget gives ~15% slack.
#
