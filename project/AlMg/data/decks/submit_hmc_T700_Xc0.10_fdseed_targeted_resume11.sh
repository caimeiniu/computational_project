#!/bin/bash
# Resume11 of the T=700 K, X_c=0.10 FD-seeded targeted-swap UB chain.
# resume10 completed cleanly at X_GB=0.2094 and is still descending:
# Q5-Q1 = -0.00273 (~9.6 CI half-widths), fwd/rev = 0.917.

#SBATCH --job-name=hmc_AlMg_T700_Xc0.10_fdseed_targeted_resume11
...
RSTFILE=$RUN_DIR/hmc_T700_Xc0.10_fdseed_targeted_resume10.rst2
...
SWAPS_PER_CALL=50
RESTART_PS=5
OUTSTUB="hmc_T700_Xc0.10_fdseed_targeted_resume11"
FD_PRED=0.2956

echo "=========================================================="
echo "Job ID         : $SLURM_JOB_ID"
echo "Variant        : targeted RESUME11 of T=700 K X_c=0.10 fdseed/UB"
echo "Deck           : $DECK"
echo "T              : $T K"
echo "X_c            : $XC"
...
echo "Previous X_GB  : resume10 = 0.2094, still drifting downward"
echo "LB partner     : hmc_T700_Xc0.10_random_targeted_resume7"
